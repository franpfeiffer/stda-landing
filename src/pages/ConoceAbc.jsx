export default function ConoceAbc() {
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-pink-400 to-pink-500 text-white py-20 overflow-hidden">
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              TENER EL <span className="text-blue-900 font-extrabold">#ASMABAJOCONTROL</span> ES POSIBLE, CON UN TRATAMIENTO REGULAR
            </h1>
            <a
              href="https://www.asthmacontroltest.com/es-ar/welcome/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-white text-pink-500 px-6 py-3 rounded-full font-medium hover:bg-gray-100 transition-colors mt-6"
            >
              HACÉ EL TEST AHORA
            </a>
          </div>
      ...
      <section className="py-16 bg-teal-500 text-white">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-10 max-w-4xl mx-auto">
            {/* Testimonial 1 */}
            <div className="bg-yellow-100 rounded-lg p-6 shadow-md text-gray-800">
              <div className="mb-4">
                <img
