            ...
            {isMenuOpen && (
                <div className="lg:hidden py-2 px-4">
                    <div className="flex flex-col space-y-2">
                        <div>
                            ...
                            {asmaDropdown && (
                                <div className="pl-4 py-2 flex flex-col space-y-2">
                                    ...
                                    <SmoothLink to="/asma#senalesAsma" className="text-sm text-[#024A9E]">SEÑALES ASMA</SmoothLink>
                                </div>
                            )}
                        </div>
                        ...
                        <Link to="/especialistas" className="px-3 py-2 text-base font-bold text-blue-900">
                            ESPECIALISTAS
                        </Link>

                        <Link to="/conoce-abc" className="px-3 py-2 text-base font-bold bg-pink-400 text-white rounded-full text-center">
                            CONOCÉ ABC
                        </Link>
